...
@add_arg_scope
def bilinear_conv2d(inputs, filters, rescale, bias=None, padding='SAME', stride=list([1, 1, 1, 1]),
...
@add_arg_scope
def multi_conv2d(inputs, filters, bias=None, stride=list([1, 1, 1, 1]),
...
@add_arg_scope
def multi_conv2d_modified(inputs, filters, bias=None,
...
@add_arg_scope
def multi_conv2d_modified2(inputs, filters, bias=None,
                           stride=list([1, 1, 1, 1]), padding='SAME', basis_rate=list([1, 3, 5]),
                           to_batch_norm=False, batch_norm_decay=0.997, is_training=True, activation_fn=None):
    _number_of_basis = len(basis_rate)
    # _filter_shape = tf.shape(filters)
...
@add_arg_scope
def scale_conv2d(inputs, filters, bias=None, stride=list([1, 1, 1, 1]), padding='SAME',
