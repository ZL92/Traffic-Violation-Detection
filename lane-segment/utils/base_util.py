...
def random_integers(min, max, size, exclude=None):
    if max < min:
...
def random_select(data_list, size, exclude=None, return_unselected=False):
...
def extract_roi(image, img_size, roi_size):
    """
